            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="presentation" class="col-md-4 col-form-label text-md-right">{{ __('presentation') }}</label>

                            <div class="col-md-6">
                                <input id="presentation" type="text" class="form-control @error('presentation') is-invalid @enderror" name="presentation" value="{{ old('presentation') }}" required autocomplete="presentation" autofocus>
